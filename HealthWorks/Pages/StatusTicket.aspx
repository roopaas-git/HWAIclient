<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/HealthMaster.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="StatusTicket.aspx.cs" Inherits="HealthWorks.Pages.StatusTicket" %>
        ...
        <ContentTemplate>
            ...
            <div class="content">
                <div class="main-header" runat="server" id="divMainHeader">
                    <h2>
                        <asp:Label Text="Status Tickets" runat="server" ID="pageName" /></h2>
                    <em>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Status" HeaderStyle-ForeColor="#585858" SortExpression="Ticket_Status"
                                                        HeaderStyle-Font-Underline="true">
                                                         <HeaderTemplate>
                                                            <asp:Label ID="lbDategrdheader123" ToolTip="click here to sort by Status" runat="server" Text="Status"></asp:Label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                            ...
                            <div class="widget" id="upd" runat="server">
                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-sm-4">
                                            <asp:DropDownList ID="ddlReopen" runat="server" OnSelectedIndexChanged="ddlReopen_SelectedIndexChanged"
                                                AutoPostBack="true" CssClass="custom-select" ClientIDMode="Static">
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-sm-2">
                                            <asp:Button Text="Submit" Enabled="false" runat="server" ID="btnReopen" CssClass="btn form-control"
                                        ...
                                        <div class="col-sm-2">
                                            <asp:Button Text="Cancel" Enabled="false" runat="server" ID="btnCancel2" CssClass="btn form-control"
