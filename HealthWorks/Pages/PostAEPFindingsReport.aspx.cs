...
{
    public partial class PostAEPFindingsReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    pdfdisplay.Src = Constants.PostAEPFindingsReport;
                }
                HideHelpLink();
            }
            catch (Exception ex)
        ...
        {
            HtmlControl htmlctl = ((HtmlControl)Master.FindControl("UnlimitedIntelC1L6Li"));
            if (htmlctl != null)
            {
        ...
        protected void lbFullScreen_Click(object sender, EventArgs e)
        {
            try
            {
                string viewPdf = Constants.PostAEPFindingsReport;                   
